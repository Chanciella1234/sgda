...
@WebServlet(name = "AgentDemandeCommentServlet", urlPatterns = {"/agent/demande/comment"})
public class AgentDemandeCommentServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        redirect(request, response, "/agent/demande/detail?id=" + demandeId);
    }
}
