...
@WebServlet(name = "AgentDemandeValiderServlet", urlPatterns = {"/agent/demande/valider"})
public class AgentDemandeValiderServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            demandeService.valider(demandeId, user.getId());
            setFlash(request, "success", "Demande validee.");
