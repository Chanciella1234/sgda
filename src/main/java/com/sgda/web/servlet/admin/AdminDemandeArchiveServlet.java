...
@WebServlet(name = "AdminDemandeArchiveServlet", urlPatterns = {"/admin/demande/archive"})
public class AdminDemandeArchiveServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            demandeService.archiver(demandeId, user.getId());
            setFlash(request, "success", "Demande archivee.");
