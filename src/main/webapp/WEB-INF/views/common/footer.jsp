<%@ taglib uri="jakarta.tags.core" prefix="c" %>
                <div class="app-footer">SGDA &copy; 2026 - Plateforme de gestion des demandes academiques</div>
            </div>
        </main>
    </div>
</div>
    ...
    <div class="confirm-dialog" role="dialog" aria-modal="true" aria-labelledby="confirmTitle" aria-describedby="confirmMessage">
        ...
        <div class="confirm-dialog-body">
            ...
            <div class="confirm-copy">
                <p class="confirm-kicker">Confirmation</p>
        ...
        <div class="confirm-actions">
            <button id="confirmCancel" type="button" class="btn btn-secondary">Annuler</button>
